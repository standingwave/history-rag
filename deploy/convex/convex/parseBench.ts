...
const CASES: Case[] = [
  ...
  { text: "add sunscreen to the beach list",
    want: [[{ kind: "note", text: /sunscreen/ }],
           [{ kind: "listCreate", name: /beach/, items: [/sunscreen/] }]] },
  { text: "make a costco list with milk, eggs, and bread",
    want: [[{ kind: "listCreate", name: /costco/, items: [/milk/, /eggs/, /bread/] }]] },
  { text: "start a new packing list for the trip",
    want: [[{ kind: "listCreate", name: /packing|trip/ }]] },
  // timers
