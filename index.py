...
import requests
import config
from sources import claude, shell, appusage, browser, git, obsidian, calendar, email, digest

# digest runs last: it reads this run's freshly committed claude chunks.
ALL_SOURCES = [claude, shell, appusage, browser, git, obsidian, calendar, email, digest]
